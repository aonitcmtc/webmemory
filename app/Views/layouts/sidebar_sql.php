...
<div class="left-menu">
    ...
    <ul class="list-group list-group-flush">
        ...
        <!-- <a href="/sql/history" class="text-decoration-none">
            <li class="<?= $sql_path == '/sql/history' ? 'active':''?> dropdown list-group-item d-flex justify-content-between align-items-center list-group-item-action list-group-item-hover">
                History
            </li>
        </a> -->
